...
public class MeetingTimePriority {
	...
	@Builder
	public MeetingTimePriority(String meetingId, String name, LocalDateTime startTime, LocalDateTime endTime) {
		Assert.notNull(meetingId, "meeting must not be null");
